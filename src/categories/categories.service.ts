...
export class CategoriesService {
  ...
  async createCategory(createCategoryDto: CreateCategoryDto, userId: string, houseId: string) {
  ...
  async updateCategory(categoryId: string, updateData: Partial<CreateCategoryDto>, userId: string) {
